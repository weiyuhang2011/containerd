...
const (
	FAKE_SANDBOX_ANNOTATION    = "fake.sandboxid.kubeos.openeuler.org"
	SANDBOX_REMAP_ANNOTATION   = "sandboxid.kubeos.openeuler.org"
	CONTAINER_REMAP_ANNOTATION = "containerid.kubeos.openeuler.org"
)
